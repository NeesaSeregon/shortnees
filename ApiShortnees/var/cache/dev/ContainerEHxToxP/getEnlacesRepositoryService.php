 ...
 */
class getEnlacesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnlacesRepository' shared autowired service.
     *
     * @return \App\Repository\EnlacesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnlacesRepository.php';

        return $container->privates['App\\Repository\\EnlacesRepository'] = new \App\Repository\EnlacesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
