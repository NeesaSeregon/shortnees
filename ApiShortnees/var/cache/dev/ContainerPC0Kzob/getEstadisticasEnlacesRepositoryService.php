 ...
 */
class getEstadisticasEnlacesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EstadisticasEnlacesRepository' shared autowired service.
     *
     * @return \App\Repository\EstadisticasEnlacesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EstadisticasEnlacesRepository.php';

        return $container->privates['App\\Repository\\EstadisticasEnlacesRepository'] = new \App\Repository\EstadisticasEnlacesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
